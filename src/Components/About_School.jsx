...
const About_School = () => {
  return (
    <>
      <Navbar />
      <section class="py-20 bg-white sm:py-16 lg:py-24">
        <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-0">
          ...
          <div class="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-6">
            <div>
              <img
                class="mx-auto sm:max-w-xs h-80 w-80"
            ...
            <div>
              ...
              <p>
                ...
                learnings through practical understanding.
              </p>
              ...
              <p className="pt-6">
                We have achieved outstanding results on all the above criterian
