...
const Navbar = () => {
  ...
  >
    {/* Icon here */}
    <span className="icon-class">🏠</span> {/* Example Icon */}
    <span>Home</span>
  </a>
  <a
    href="/About_School"
    ...
    <span>Contact us</span>
            ...
            <div className="hidden sm:flex items-center space-x-3">
              ...
              <a
                    href={Instagram}
                    title=""
                    class="flex items-center justify-center text-gray-800 transition duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-orange-600 hover:text-white hover:bg-orange-600 hover:border-orange-600"
                  >
                    <svg
                      class="w-6 h-6"
                      xmlns="http://www.w3.org/2000/svg"
